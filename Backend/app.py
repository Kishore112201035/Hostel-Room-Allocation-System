...
#     wb.remove(ws_final)
# wb.create_sheet("final allocation")
# ws_final = wb["final allocation"]
...
#     email, _, _, floor1, pref1, floor2, pref2, floor3, pref3 = row[:9]
#     if not email:
#         continue
...
#     # Try Pref 1
#     if pref1 and floor1:
#         allocated = allocate_room(pref1, floor1)

#     # Try Pref 2
#     if not allocated and pref2 and floor2:
#         allocated = allocate_room(pref2, floor2)

#     # Try Pref 3
#     if not allocated and pref3 and floor3:
#         allocated = allocate_room(pref3, floor3)
